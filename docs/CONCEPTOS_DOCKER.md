...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15457"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11457"| SQLSERVER
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13351"| MARIADB
```
