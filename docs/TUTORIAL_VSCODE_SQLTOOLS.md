...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15457`.
...
| Port | `15457` | El puerto del host del compose (`15457:1433`) |
...
> El puerto es la clave: **15457, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15457
...
>
> ```
> Error opening connection Failed to connect to localhost:15457
...
> (`http://localhost:8061/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15457) con test y guardarla |
