...
**Sus puertos:** API 8161 · PostgreSQL 15557 · **SQL Server 11557**
...
1. **Carpeta nueva de specs** y copia desde el clon del curso (ajuste la
   ...
   Copy-Item ..\proyecto_diseno_de_software6\docs\spec_kit\versiones\v4_sqlserver\* docs\spec_kit\versiones\v4_sqlserver\
   ```
...
2. **La BD SQL Server y su inicializador** — cópielos tal cual del clon
   ...
   ```powershell
   Copy-Item ..\proyecto_diseno_de_software6\db\bdfacturas_sqlserver.sql db\
   Copy-Item ..\proyecto_diseno_de_software6\db\init_sqlserver.sh db\
   ```
...
- El ancla de stack queda igual; a los puertos +100 agregue:
  *"SQL Server publica en 11557 (no 11457)"*.
