...
| `docker-compose.yml` | ★ servicio `mariadb` (11, :13351, se siembra solo) + `ConnectionStrings__MariaDb` |
...
- Puertos publicados: 8061 (API) · 15457 (postgres) · 11457 (sqlserver)
  · **13351 (mariadb)**. Reconstrucción del estudiante: +100 (13451).
