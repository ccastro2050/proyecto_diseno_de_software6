...
2. **Copie las specs de la v2** desde el clon del curso (los 7 `.md` +
   ...
   ```powershell
   Copy-Item ..\proyecto_diseno_de_software6\docs\spec_kit\versiones\v2_persona_factura\* docs\spec_kit\versiones\v2_persona_factura\
   ```
...
7. Mi proyecto corre con los puertos de la v1 desplazados +100 (convivo
   con el clon del curso): API en 8161 y PostgreSQL en 15557, con
   name: mi_v1_producto en el compose. Cuando me des URLs o comandos de
   prueba, usa localhost:8161 y localhost,15557.
...
3. **El cierre es doble**: primero la REGRESIÓN de la v1 (su smoke test
   ...
   puertos: donde el quickstart diga `8061` use `8161`.
