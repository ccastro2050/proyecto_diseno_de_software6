...
> curso corriendo. Puerto del estudiante: **8162**.
...
Flask + Jinja2 (Python) llamado front_flask, puerto 8162, que consume la
API de facturas en http://localhost:8061 (variable de entorno
